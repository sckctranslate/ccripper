...
<html class="mdc-typography">
  ...
  <head>
    ...
    <title>Google Play | CC 字幕抓取工具 | Translated by @SerCom_KC</title>
  ...
  <body>
    ...
    <header class="mdc-toolbar mdc-toolbar--fixed">
      <div class="mdc-toolbar__row">
        <section class="mdc-toolbar__section mdc-toolbar__section--align-start">
          ...
          <span class="mdc-toolbar__title">Google Play</span></section>
      </div>
    </header>
    <!-- Navigation -->
      ...
      <nav class="mdc-temporary-drawer__drawer">
        ...
        <nav class="mdc-temporary-drawer__content mdc-list">
          <a class="mdc-list-item" href="/">
            <i class="material-icons mdc-list-item__start-detail" aria-hidden="true">home</i>首页</a>
          <a class="mdc-list-item" href="https://www.sckctranslate.download">
            <i class="material-icons mdc-list-item__start-detail" aria-hidden="true">arrow_back</i>返回资源站</a>
          <hr class="mdc-list-divider">
          <a class="mdc-list-item mdc-temporary-drawer--selected" href="/googleplay/">Google Play</a>
          <a class="mdc-list-item" href="/hulu/">Hulu</a></nav>
        <footer class="mdc-temporary-drawer__footer">
    ...
    <main class="scrollbar">
      ...
      <p class="mdc-typography--body1">首先，您需要在 <a href="https://play.google.com/store">Google Play</a> 上找到您想要提取 CC 字幕的视频。我们暂时不支持 YouTube 付费内容的链接，但您应该能在 Google Play 上找到同样的内容。</p>
          <p class="mdc-typography--body1">然后，您需要将视频对应的链接粘贴至上方文本框。根据视频的属性（TV 剧集或电影），获取链接的方式会有所不同，因此请仔细阅读下方说明。</p>
      <p class="mdc-typography--body1">如果您想要获取的是 TV 剧集中的某一集的 CC 字幕，请在这一集的封面上单击鼠标右键，然后选择“复制链接地址”（或类似选项）。
        <br>将链接粘贴至上方文本框。
        <br>例如 <i>The Powerpuff Girls: Dance Pantsed Special</i> 的链接为“https://play.google.com/store/tv/show?id=Du0ZkPjtlss&cdid=tvseason-sLa2nq0_HgY&gdid=tvepisode-qGnkhd7OIrU”。
        <br>
        <img src="https://sckctc4j.landcement.com/ccripper/googleplay/tvepisode-example.png" style="width: 100%; max-width: 869px;" /></p>
      <p class="mdc-typography--body1">如果您想要获取的是一部电影的 CC 字幕，请于搜索结果页面中在这部电影的海报上单击右键，然后选择“复制链接地址”（或类似选项）。
        <br>将链接粘贴至上方文本框。
        <br>例如 <i>Teen Titans: Trouble in Tokyo</i> 的链接为“https://play.google.com/store/movies/details/Teen_Titans_Trouble_in_Tokyo?id=3y7PkIFwv5o”。
        <br>
        <img src="https://sckctc4j.landcement.com/ccripper/googleplay/movie-example.png" style="width: 100%; max-width: 869px;" /></p>
    ...
    <script>let drawer = new mdc.drawer.MDCTemporaryDrawer(document.querySelector('.mdc-temporary-drawer'));
...
{
        exec("python googleplay.py '$link' $lang", $output);
        $videoID = $output[0];
        $result = $output[1];
        ...
        {
                case "SUCCESS":
                        echo '<script>setTimeout(function() {window.location.href = "'. $videoID .'.'. $lang .'.srt";}, 500);</script>';
                ...
                case "VIDEO_UNSUPPORTED":
                        $snackBarMsg = '我们暂时不支持所请求视频的 CC 字幕抓取。请联系我们。';
                        break;
                case "VIDEO_NOT_FOUND":
                        $snackBarMsg = '您所请求的视频不存在。请检查您的输入是否有误。';
                        break;
                case "CAPTION_NOT_FOUND":
                        $snackBarMsg = '您所请求的视频中不包含对应语言的 CC 字幕。这可能是因为视频本身不含 CC 字幕，或者您输入了错误的语言代码。请检查您的输入是否有误。';
                        break;
                default:
